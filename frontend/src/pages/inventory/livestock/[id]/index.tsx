...
import FamilyTree from '@/components/Livestock/FamilyTree'
...
const LivestockDetail: NextPage = () => {
    const isMounted = useRef(false)
    const [livestockData, setLivestockData] = useState<Livestock | undefined>()
    ...
    const loadData = () => {
        ...
        LivestockService.getItem(id as string)
            .then((data: Livestock) => {
    ...
    const markLivestockDeceased = async () => {
        await LivestockService.markDeceased(id as string)
    }
